 ...
 */
export function generateNamingConventions(baseName: string, description?: string): NamingConventions {
 ...
 */
export function replacePlaceholders(content: string, conventions: NamingConventions): string {
  let result = content;
 ...
 */
export function replacePathPlaceholders(path: string, conventions: NamingConventions): string {
  let result = path;
