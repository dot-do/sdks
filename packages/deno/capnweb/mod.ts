/**
 * @dotdo/capnweb - Deno-native capability-based RPC
 *
 * A lightweight, type-safe RPC library for Deno supporting WebSocket and HTTP transports.
 *
 * @module
 * @example
 * ```typescript
 * import { rpc } from "@dotdo/capnweb";
 *
