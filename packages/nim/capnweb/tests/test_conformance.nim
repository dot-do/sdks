## DotDo Cap'n Web Conformance Tests for Nim
...
suite "DotDo Cap'n Web Conformance Tests":
...
when isMainModule:
  echo "Running DotDo Cap'n Web Conformance Tests for Nim"
