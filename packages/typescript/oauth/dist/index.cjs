...
var platform_do = require('platform.do');
var rpc_do = require('rpc.do');
...
__export(storage_exports, {
  CompositeTokenStorage: () => exports.CompositeTokenStorage,
  FileTokenStorage: () => exports.FileTokenStorage,
  KeychainTokenStorage: () => exports.KeychainTokenStorage,
  LocalStorageTokenStorage: () => exports.LocalStorageTokenStorage,
  MemoryTokenStorage: () => exports.MemoryTokenStorage,
  SecureFileTokenStorage: () => exports.SecureFileTokenStorage,
...
function createSecureStorage(storagePath) {
  if (isNode()) {
    return new exports.SecureFileTokenStorage(storagePath);
  }
  if (typeof localStorage !== "undefined") {
    return new exports.LocalStorageTokenStorage();
  }
  return new exports.MemoryTokenStorage();
}
var KEYCHAIN_SERVICE, KEYCHAIN_ACCOUNT; exports.KeychainTokenStorage = void 0; exports.SecureFileTokenStorage = void 0; exports.FileTokenStorage = void 0; exports.MemoryTokenStorage = void 0; exports.LocalStorageTokenStorage = void 0; exports.CompositeTokenStorage = void 0;
var init_storage = __esm({
  "src/storage.ts"() {
    KEYCHAIN_SERVICE = "oauth.do";
    KEYCHAIN_ACCOUNT = "access_token";
    exports.KeychainTokenStorage = class {
      keytar = null;
      initialized = false;
      /**
    ...
    exports.SecureFileTokenStorage = class {
      tokenPath = null;
      configDir = null;
      initialized = false;
      customPath;
    ...
    exports.FileTokenStorage = class {
      tokenPath = null;
      configDir = null;
      initialized = false;
      async init() {
    ...
    exports.MemoryTokenStorage = class {
      token = null;
      async getToken() {
        return this.token;
      }
    ...
    exports.LocalStorageTokenStorage = class {
      key = "oauth.do:token";
      async getToken() {
        if (typeof localStorage === "undefined") {
          return null;
    ...
    exports.CompositeTokenStorage = class {
      keychainStorage;
      fileStorage;
      preferredStorage = null;
      constructor() {
        this.keychainStorage = new exports.KeychainTokenStorage();
        this.fileStorage = new exports.SecureFileTokenStorage();
      }
      /**
...
async function createAuthenticatedClient(options = {}) {
  ...
  const client = new platform_do.DotDo({
    ...dotdoOptions,
...
Object.defineProperty(exports, "PoolTimeoutError", {
  enumerable: true,
  get: function () { return platform_do.PoolTimeoutError; }
});
Object.defineProperty(exports, "connect", {
  enumerable: true,
  get: function () { return platform_do.connect; }
});
Object.defineProperty(exports, "CapabilityError", {
  enumerable: true,
  get: function () { return rpc_do.CapabilityError; }
});
Object.defineProperty(exports, "CapnwebError", {
  enumerable: true,
  get: function () { return rpc_do.CapnwebError; }
});
Object.defineProperty(exports, "ConnectionError", {
  enumerable: true,
  get: function () { return rpc_do.ConnectionError; }
});
Object.defineProperty(exports, "RpcClient", {
  enumerable: true,
  get: function () { return rpc_do.RpcClient; }
});
Object.defineProperty(exports, "RpcError", {
  enumerable: true,
  get: function () { return rpc_do.RpcError; }
});
Object.defineProperty(exports, "TimeoutError", {
  enumerable: true,
  get: function () { return rpc_do.TimeoutError; }
});
Object.defineProperty(exports, "connectRpc", {
  enumerable: true,
  get: function () { return rpc_do.connect; }
});
exports.auth = auth;
exports.authorizeDevice = authorizeDevice;
exports.buildAuthUrl = buildAuthUrl;
exports.configure = configure;
exports.connectAuthenticated = connectAuthenticated;
exports.createAuthFactory = createAuthFactory;
exports.createAuthenticatedClient = createAuthenticatedClient;
exports.createAuthenticatedRpcSession = createAuthenticatedRpcSession;
exports.createDirectRpcClient = createDirectRpcClient;
...
exports.pollForTokens = pollForTokens;
exports.pollGitHubDeviceFlow = pollGitHubDeviceFlow;
exports.startGitHubDeviceFlow = startGitHubDeviceFlow;
