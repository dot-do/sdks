...
function createConnection(options) {
  const client = rpc_do.connect(options.url || "", options);
  return {
    connection: {
      close: async (_reason) => {
        await client.close();
...
async function withRetry(fn, options, onRetry) {
  ...
  for (let attempt = 0; attempt < options.maxAttempts; attempt++) {
    if (options.timeout && Date.now() - startTime >= options.timeout) {
      throw new rpc_do.TimeoutError(`Retry operation timed out after ${options.timeout}ms`);
    }
    if (options.signal?.aborted) {
      const err = new Error("Operation aborted");
      err.name = "AbortError";
...
var DotDo = class {
  ...
  connectOnce(service) {
    const url = this.resolveUrl(service);
    const connectionOptions = this.buildConnectionOptions(url);
    return rpc_do.connect(url, connectionOptions);
  }
  /**
...
var PoolTimeoutError = class _PoolTimeoutError extends rpc_do.CapnwebError {
...
Object.defineProperty(exports, "ErrorCode", {
  enumerable: true,
  get: function () { return rpc_do.ErrorCode; }
});
Object.defineProperty(exports, "ErrorCodeName", {
  enumerable: true,
  get: function () { return rpc_do.ErrorCodeName; }
});
...
Object.defineProperty(exports, "SerializationError", {
  enumerable: true,
  get: function () { return rpc_do.SerializationError; }
});
...
Object.defineProperty(exports, "createError", {
  enumerable: true,
  get: function () { return rpc_do.createError; }
});
Object.defineProperty(exports, "isErrorCode", {
  enumerable: true,
  get: function () { return rpc_do.isErrorCode; }
});
Object.defineProperty(exports, "wrapError", {
  enumerable: true,
  get: function () { return rpc_do.wrapError; }
});
exports.DotDo = DotDo;
exports.PoolErrorCode = PoolErrorCode;
