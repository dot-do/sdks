defmodule CapnWeb.MixProject do
  use Mix.Project

  @version "0.1.0"
  @source_url "https://github.com/capnweb/capnweb"
  ...
  def project do
    [
      ...
      # Hex
      description: "Cap'n Web RPC client for Elixir - Promise pipelining over WebSocket",
      package: package(),
